...
\subsection{Preprocssing}
Since we need the neural network to interpret words and letters meaningful, we first convert object and and predicate labels into vectors using GLOVE\cite{pennington2014glove}, a word-to-vector library commonly used by other works on SGG\cite{lee2018multi}. 
